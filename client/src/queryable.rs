...
pub trait Queryable<C: RpcApi + Send + Sync>: Sized {
...
#[async_trait::async_trait]
impl<C: RpcApi + Sync + Send> Queryable<C> for bitcoin::block::Block {
...
#[async_trait::async_trait]
impl<C: RpcApi + Sync + Send> Queryable<C> for bitcoin::transaction::Transaction {
...
#[async_trait::async_trait]
impl<C: RpcApi + Sync + Send> Queryable<C> for Option<crate::json::GetTxOutResult> {
